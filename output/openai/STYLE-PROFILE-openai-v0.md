...
| **指纹**（discriminate.py，vs 其余六库 pooled，MATTR 7/7 终态） | **第一人称最高**（53，p=0.002，q=0.003，过 FDR）——侦探叙事 "we" 主体；精确数字最低（0.92）退居次显著。**2026-09-14 两层口径复核：体裁构成校正后未过 FDR，原信号以构成成分为主**（共享格内第一人称差异大幅消融：R 格 55.5 vs 同格 pooled 22.0，p=0.347，q=0.687；E 格 p=0.275；新口径最显著信号=限定语高 @R格 15.1 vs 7.98，p=0.023，q=0.351，探索性） | — |
