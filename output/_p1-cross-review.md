...
- **openai**：库特征完成度四篇最高——单句段节拍器 6 处、Bug 编号侦探链、格言模板逐字命中；hedge 12.3 高于 median 9.57 但在 IQR 内（侦探语气效应，核验更正：非"超 P75"）
- **anthropic**：库特征命中率最高——六签名元素全部落位（澄清指控/自我批评节/边界声明/三原则/概念命名/模式清单），postmortem+playbook 双谱系组合进非原生题材；**人称 57 vs median 30 是四篇最大 median 偏离（约 2 倍，仍在 IQR [21,69] 内）**
